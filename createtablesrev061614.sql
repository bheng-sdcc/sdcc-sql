...
(
  ...
  act_desc 			character varying(50) NOT NULL,
...
(
  ...
  suffix 		character varying(5),
  person_status 	boolean,
  CONSTRAINT coop_personality_pk PRIMARY KEY (pers_id_no),
...
(
  ...
  CONSTRAINT coop_empl_dtl_pk PRIMARY KEY (empl_dtl_no),
...
(
  ...
  CONSTRAINT coop_pers_act_act_num_fkey FOREIGN KEY (act_num)
      REFERENCES coop_activity (act_num) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION,
  CONSTRAINT coop_pers_act_pers_id_no_fkey FOREIGN KEY (pers_id_no)
      REFERENCES coop_personality (pers_id_no) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION
)
WITH (
  OIDS=FALSE
...
(
  ...
  CONSTRAINT coop_pers_ext_org_ext_org_no_fkey FOREIGN KEY (ext_org_no)
      REFERENCES coop_ext_org (ext_org_no) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION,
  CONSTRAINT coop_pers_ext_org_pers_id_no_fkey FOREIGN KEY (pers_id_no)
      REFERENCES coop_personality (pers_id_no) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION
)
WITH (
...
(
  ...
  main_criteria_no 		serial NOT NULL,
  main_criteria_dtl 		text,
  sub_criteria 			boolean,
  CONSTRAINT coop_pros_criteria_main_pk PRIMARY KEY (main_criteria_no),
...
(
  main_pros_rating_no 		serial NOT NULL,
  main_criteria_no 		integer,  
  main_criteria_rating 		integer,
  pros_rep_num 			integer,
 
  CONSTRAINT coop_pros_rating_main_pk PRIMARY KEY (main_pros_rating_no),
  CONSTRAINT coop_pros_rating_main_main_criteria_no_fkey FOREIGN KEY (main_criteria_no)
      REFERENCES coop_pros_criteria_main (main_criteria_no) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION,
   CONSTRAINT coop_pros_repver_pros_rep_num_fkey FOREIGN KEY (pros_rep_num)
      REFERENCES coop_pros_report (pros_rep_num) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION
...
(
  sub_criteria_no 		serial NOT NULL,
  main_criteria_no		integer NOT NULL,
  main_sub_no			integer NOT NULL,
  sub_criteria_dtl 		text,
    CONSTRAINT coop_pros_criteria_sub_pk PRIMARY KEY (sub_criteria_no),
  CONSTRAINT coop_pros_criteria_sub_main_criteria_no_fkey FOREIGN KEY (main_criteria_no)
      REFERENCES coop_pros_criteria_main (main_criteria_no) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION
)
WITH (
...
(
  sub_pros_rating_no serial NOT NULL,
  main_criteria_no integer,
  sub_criteria_no integer,
  sub_criteria_rating integer,
  CONSTRAINT coop_pros_rating_sub_pkey PRIMARY KEY (sub_pros_rating_no),
  CONSTRAINT coop_pros_rating_sub_main_criteria_no_fkey FOREIGN KEY (main_criteria_no)
      REFERENCES coop_pros_criteria_main (main_criteria_no) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION,
  CONSTRAINT coop_pros_rating_sub_sub_criteria_no_fkey FOREIGN KEY (sub_criteria_no)
      REFERENCES coop_pros_criteria_sub (sub_criteria_no) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION
)
WITH (
  OIDS=FALSE
